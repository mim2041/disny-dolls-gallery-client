import feature1 from '../../../assets/images/features/feature1.jpeg';
import feature2 from '../../../assets/images/features/feature2.jfif';
import feature3 from '../../../assets/images/features/feature3.jpg';
import feature4 from '../../../assets/images/features/feature4.jpg';
import feature5 from '../../../assets/images/features/feature5.jfif';
    ...
    return (
        <div className="bg-pink-200 px-12 lg:px-24 py-12 text-center mt-12">
            ...
            <div className='mt-12 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6'>
                ...
                <div className='bg-green-200 shadow-xl rounded-lg w-[200px] border-[2px, solid, black]'>
                    <img className='w-[200px] h-[150px] rounded-lg' src={feature2} alt="" />
                    <div className='p-2'>
                ...
                <div className='bg-orange-200 shadow-xl w-[200px] rounded-lg border-[2px, solid, black]'>
                    <img className='w-[200px] h-[150px] rounded-lg' src={feature3} alt="" />
                    <div className='p-2'>
                ...
                <div className='bg-yellow-100 shadow-xl w-[200px] rounded-lg border-[2px, solid, black]'>
                    <img className='w-[200px] h-[150px] rounded-lg' src={feature4} alt="" />
                    <div className='p-2'>
                ...
                <div className='bg-sky-200 shadow-xl w-[200px] rounded-lg border-[2px, solid, black]'>
                    <img className='w-[200px] h-[150px] rounded-lg' src={feature5} alt="" />
                    <div className='p-2'>
                ...
                <div className='bg-violet-200 shadow-xl rounded-lg w-[200px] border-[2px, solid, black]'>
