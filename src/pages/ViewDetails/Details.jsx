...
const Details = () => {
    ...
    return (
        <div className="bg-pink-100  py-12 px-12 lg:px-36">
            ...
            <div className="card py-12  lg:px-36 lg:gap-24 lg:card-side items-center bg-pink-200 shadow-xl ">
            <div className="w-100 ">
        <img src={photo} alt="toys" className=" " />
      </div>
                {/* <figure className="w-full "><img src={photo} alt="toy" className="w-full sm:mx-auto"/></figure> */}
